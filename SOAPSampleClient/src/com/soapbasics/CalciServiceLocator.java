...
public class CalciServiceLocator extends org.apache.axis.client.Service implements com.soapbasics.CalciService {
    ...
    public com.soapbasics.Calci getCalci(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soapbasics.CalciSoapBindingStub _stub = new com.soapbasics.CalciSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soapbasics.Calci.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soapbasics.CalciSoapBindingStub _stub = new com.soapbasics.CalciSoapBindingStub(new java.net.URL(Calci_address), this);
                _stub.setPortName(getCalciWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soapbasics.com", "CalciService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soapbasics.com", "Calci"));
        }
